...
public class JamPlayer {
	...
	searchText.addKeyListener(new KeyListener() {
		...
		searchChanged(searchText.getText());
	    }
	...
	// specified
	dialog = new PlayListMakerDialog(this);
    ...
    public void searchChanged(String input)
    {
	libraryModel.changeSongs(libraryModel.songsTrie.search(input));
    }
}
